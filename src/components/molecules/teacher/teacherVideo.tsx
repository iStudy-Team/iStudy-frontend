        ...
        >
            <div className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-all duration-500">
                <div className="absolute inset-0">
                    ...
                    >
                        <source
                            src="https://ila.edu.vn/wp-content/uploads/2023/10/teacher_Trailer.mp4"
                            type="video/mp4"
                        />
            ...
            <div
                ...
                px-4 sm:px-6 md:px-8 lg:px-10 xl:px-16 lg:pb-80 pb-30 "
            >
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="aspect-video w-full h-full">
                                    <iframe
                                        src="https://www.youtube.com/embed/sjMVwPotg-0?si=DOGAj2kXcBDhapMT"
