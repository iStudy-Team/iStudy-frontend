...
export default function StudentSchedule() {
    const { schedules, loading, error, getSchedulesByStudent } =
        useScheduleStore();

    // Fetch student schedules when component mounts
    useEffect(() => {
    ...
    const calendarEvents: CalendarEvent[] = useMemo(() => {
        ...
        return schedules.map((schedule) => {
            ...
            const title = schedule.class_name || `Lớp học ${schedule.class_id}`;
                ...
                <div className="flex items-center justify-center py-12">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600">
                            Bạn chưa có lịch học nào được sắp xếp
                        </p>
                    </div>
                </div>
            ) : (
